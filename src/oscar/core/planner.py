    ...
    def _call_llm(self, system_prompt: str, user_prompt: str) -> str:
        ...
        try:
            if self.provider == "groq":
                ...
                # Gemini allows only 'user' and 'model' roles.
                # Treat the system prompt as a first-message from the model.
                gemini_contents = [
                ...
                response = self.client.models.generate_content(
                    model=self.config.model,  # e.g. "gemini-2.5-flash"
    ...
    def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            test_response = self._call_llm(
                "You are a test assistant. Respond with: "
